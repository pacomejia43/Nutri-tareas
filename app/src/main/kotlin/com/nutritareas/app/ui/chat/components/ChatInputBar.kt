...
fun ChatInputBar(
    ...
    val canAttachAnything = canAttachPdf || canAttachImage || canAttachTemplate
    ...
    Surface(tonalElevation = 3.dp, modifier = modifier) {
        Row(
            ...
            Box {
                IconButton(onClick = { showAttachMenu = true }, enabled = canAttachAnything) {
                ...
                DropdownMenu(expanded = showAttachMenu, onDismissRequest = { showAttachMenu = false }) {
                    DropdownMenuItem(
                        ...
                        onClick = { showAttachMenu = false; onAttachPdf() },
                    )
                    DropdownMenuItem(
                    ...
                    DropdownMenuItem(
                        ...
                        onClick = { showAttachMenu = false; onAttachTemplate() },
                    )
                }
            }
            OutlinedTextField(
